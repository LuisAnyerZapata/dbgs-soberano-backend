...
type IntegracionRepository interface {
    ...
    // ValidarCredenciales busca directamente por el hash. 
    // Evita exponer el ID del cliente si el hash no coincide, mitigando ataques de enumeración.
    ValidarCredenciales(ctx context.Context, tokenHash string) (*entity.ClienteIntegracion, error)
